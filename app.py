...
file_ = open("GM’s Summerization.gif", "rb")
contents = file_.read()
...
# Input Video Link
url = st.sidebar.text_input('Video URL', 'https://www.youtube.com/watch?v=rv80XLxW8fE')

# Display Video and Title
from bs4 import BeautifulSoup
import requests

r = requests.get("https://www.youtube.com/watch?v=rv80XLxW8fE")
